...
// // console.log('Elzero \\ age you\ \'ahmed\'');
...
// // console.log(100000000.00012);

// // console.log(Number.MAX_SAFE_INTEGER);
// // console.log(Number.MAX_VALUE);
// // console.log(Number.MAX_VALUE + 55556555555555555555555555444444444444);

// // console.log((100).toString());
// // console.log(100.10.toString())
// // console.log(100.555555555.toFixed(5))
// // console.log(Number("100 os"));
// // console.log(+"100 os");
// // console.log(parseInt("100.500 os"));
// // console.log(parseFloat("100.500 os"));
...
// // console.log(Number.isNaN("osa"/ 520));
...
// console.log(a.endsWith("h",14).repeat(8));
...
// console.log(typeof"osa" === typeof"ahmed");
...
// let allFriends = myFriends.concat(myNewFriends, myNewFriends,SchoolFriends, "Gamal", [1,2]);
...
// console.log(calc(10,20, 10, 30, 50, 30, 400000));
...
// }
// showInfo("Osama",33,20, "No", "Html", "CSS");
...
// // get fri with name starts with A
...
//             ele.computedStyleMap.display = "none"
//         })
//     };
// });
// console.log(allLis);
...
// console.log(user.addresses.EGP);
// console.log(user.addresses.EGP.one);
// console.log(user["addresses"].EGP.one);
// console.log(user["addresses"]["EGP"]["one"]);
// console.log(user.name);
// console.log(user.name);
...
// let myIdElement = document.getElementById("m");
...
// let myParagraphText = document.createTextNode("Product Descripition");
...
// document.styleSheets[0].rules[0].style.removeProperty("line-eight");
...
// setTimeout(sayMsg, 3000, "osama", 33);
...
// let counter = setInterval(countdown, 1000, "Osama", 38);
...
// setTimeout(function () {
//   window.open("https://www.google.com.sa/", "_blank", "width=400,height=400,left=200,top=10")
// }, 2000);
...
// let myNewWindow = window.open("https://www.google.com", "", "width=500,height=500");
...
// let notnNums = "12345678910";
// let notNumsRe = /[^0-2]/g;
// console.log(notnNums.match(notNumsRe));
...
//  onemli
//مهم شرط عدد الالحرف والارقام في الفراغ
/*
  Regular Expression
